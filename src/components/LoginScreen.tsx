          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            ...
            <div className="mt-2.5 pt-2 border-t border-slate-100/80 text-[11px] text-slate-500 space-y-1 text-center">
              ...
              <p className="text-[10px] text-slate-400">
                🔒 บัญชีที่มีป้าย <span className="font-semibold text-slate-600">"ดูอย่างเดียว"</span> สามารถดูรายงานและสต๊อกได้เท่านั้น (Super Admin สามารถปรับเปลี่ยนบทบาทและสิทธิ์ของทุกบัญชีได้ตลอดเวลา)
              </p>
            </div>
          </div>
        </div>
